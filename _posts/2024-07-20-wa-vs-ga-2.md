...
<ol type="a" start="4">
  ...
  <blockquote>
  <p><u>六本木のディスコが</u>芸能人がよく来る。<br><em>Celebrities come to discotheques in Roppongi often.</em></p>
  </blockquote>
</ol> 
...
Another case where weak exclusion appears is in command statements where the subject is explicitly stated. It's rare for the subject be mentioned in commands, so when it is, it's likely because the speaker is specifying who should carry out the command, adding exclusive nuance.
