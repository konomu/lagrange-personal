...
When a sentence has two or more clauses, the clause with its predicate at the end of the sentence is usually the **main clause**. All clauses that are nested within it are **subordinate clauses**.[^2] If a sentence only has one clause, then that clause is the main clause. Take a look at the following sentences with their clauses highlighted.

[^2]: It's also possible for subordinate clauses to be nested within subordinate clauses.
...
## Rules of Subordinate Clauses

We will go over choosing は vs. が in main clauses in sections. For now, we will focus on how to use 
...
<tbody>
  <tr>
    ...
    <td style="text-align: right;" class="tg-0pky">Incidental Clauses</td>
  ...
  <tr>
    <td style="text-align: right;" class="tg-0pky">Suppositional Clauses</td>
    <td class="tg-0pky">〜たら, 〜(れ)ば, 〜と, 〜&#8288;ては, 〜&#8288;ても</td>
  </tr>
  <tr>
    <td style="text-align: right;" class="tg-0pky">Situational Clauses</td>
  ...
  <tr>
    <td style="text-align: right;" class="tg-0pky">Causal Clauses</td>
...
## Basic Principles of は/が in Clauses



太郎は部屋に入ると、( WHO? )すぐに電気をつけた。

Examples of incidental clauses
